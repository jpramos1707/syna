...
export function DiagnosticWizard({ clientId, onSave, onClose }: DiagnosticWizardProps) {
    ...
    if (saved) {
      try {
        ...
        return {
          ...
          ...parsed,
          financial: {
            ...INITIAL_DIAGNOSTIC_DATA.financial,
            ...(parsed.financial || {}),
            clientOrigin: {
              ...INITIAL_DIAGNOSTIC_DATA.financial.clientOrigin,
              ...(parsed.financial?.clientOrigin || {}),
            },
          },
          history: {
            ...INITIAL_DIAGNOSTIC_DATA.history,
            ...(parsed.history || {}),
            socialMedia: {
              ...INITIAL_DIAGNOSTIC_DATA.history.socialMedia,
              ...(parsed.history?.socialMedia || {}),
            },
            paidTraffic: {
              ...INITIAL_DIAGNOSTIC_DATA.history.paidTraffic,
              ...(parsed.history?.paidTraffic || {}),
            },
            googleOrganic: {
              ...INITIAL_DIAGNOSTIC_DATA.history.googleOrganic,
              ...(parsed.history?.googleOrganic || {}),
            },
          },
        };
      } catch (error) {
        console.error("Error parsing saved diagnostic data:", error);
        return INITIAL_DIAGNOSTIC_DATA;
      }
    }
    return INITIAL_DIAGNOSTIC_DATA;
  });
  ...
  return (
    <div className="flex flex-col h-full max-h-[75vh]">
      ...
      <div className="flex-1 overflow-y-auto px-1 scrollbar-thin mt-4">
        {renderStep()}
      </div>
